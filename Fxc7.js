...
prefix = "!"
name = "MR KING BOT"
rdaftar = "TERIMA KASIH TELAH DAFTAR DI DATABASE MR KING😁"
rmenu = "HAI GAN👋 JANGAN LUPA SUBSCRIBE CHANNEL MRKING YAA:)"
botinfo = "UNTUK INVITE BOT SILAHKAN SUBSCRIBE CHANNEL KAMI DULU YAA:)"
limitt = 50
memberLimit = 2
ban = []
premium = ["18313535216@s.whatsapp.net","12084238755@s.whatsapp.net","6282246586611@s.whatsapp.net"]
...
async function starts() {
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `Hai Gan ${pushname2} Kamu Belum Terdaftar Didatabase Kami Silahkan Ketik \n${prefix}daftar`,
			...
			const ownerNumber = ["6282246586611@s.whatsapp.net","12084238755@s.whatsapp.net","18313535216@s.whatsapp.net"]
		...
		case 'daftar':
					...
					if (isUser) return reply('kamu sudah Menjadi Di Database Bot Kami Gan')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
